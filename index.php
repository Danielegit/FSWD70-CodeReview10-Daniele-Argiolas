...
<div class="col-lg-4">
	...
	<div>
		<form class="d-flex justify-content-end" action="index.php" method="POST" accept-charset="utf-8">
			...
			<input class="w-50 btn-success" type="submit" name="sort" value="Genre">
		</form>	
	</div>
	<hr>
	...
	<div>
		<form class="d-flex justify-content-end" action="index.php" method="POST" accept-charset="utf-8">
			...
			<input class="w-50 btn-success" type="submit" name="type_sort" value="Type">
		</form>	
	</div>
	<hr>
	...
	<div>
		<form class="d-flex justify-content-end" action="index.php" method="POST" accept-charset="utf-8">
			...
			<input class="w-50  btn-success" type="submit" name="autore" value="author">
		</form>	
	</div>
	<hr>
	...
	<div>
		<form class="d-flex justify-content-end" action="index.php" method="POST" accept-charset="utf-8">
			...
			<input class="w-50  btn-success" type="submit" name="firma" value="publisher">
		</form>	
	</div>
	<hr>
	...
	<div>
		<form class="d-flex justify-content-end" action="index.php" method="POST" accept-charset="utf-8">
			<input class="w-100 btn-success" type="submit" name="default" value="View All">
		</form>
	</div>
	<hr>
